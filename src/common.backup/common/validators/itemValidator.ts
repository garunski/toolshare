...
export class ItemValidator {
  ...
  static validateItemCreation(data: unknown) {
    return itemCreationSchema.parse(data);
  }

  // Validate item update data
  static validateItemUpdate(data: unknown) {
    return itemUpdateSchema.parse(data);
  }

  // Validate search filters
  static validateSearchFilters(data: unknown) {
  ...
  // Sanitize item data
  static sanitizeItemData(data: any) {
    return {
      ...data,
      name: data.name?.trim(),
