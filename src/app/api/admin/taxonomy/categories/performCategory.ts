...
import { BuildCategoryTree } from "../tree/buildCategoryTree";

import { PerformCategoryCRUD } from "./crud/performCategoryCRUD";

export class PerformCategory {
  ...
  static async getAllCategoriesTree(): Promise<CategoryTreeNode[]> {
    ...
    return BuildCategoryTree.getCategoryHierarchy(data);
  }
  ...
  static async createCategory(
    ...
    return PerformCategoryCRUD.createCategory(categoryData);
  }
  ...
  static async updateCategory(
    ...
    return PerformCategoryCRUD.updateCategory(updateData);
  }

  // Delete category (soft delete - mark as inactive)
  static async deleteCategory(categoryId: string): Promise<void> {
    return PerformCategoryCRUD.deleteCategory(categoryId);
  }
